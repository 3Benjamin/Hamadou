...
<script src="maps/bf-reg.min.js"></script>
<div id="container-bf-region"></div>
...
<script>
  ...
  Highcharts.maps["countries/bf/bf-reg"].features
  ...
  // Create the chart
  Highcharts.mapChart('container-bf-region', {
    chart: {
      map: 'countries/bf/bf-reg',
      animation: false,
      events: {
        load: function () {
          ...
          regionData.forEach(function (point) {
    ...
    title: {
      text: 'Current temperatures in region of Burkina Faso'
    },
